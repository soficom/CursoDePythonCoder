# def ciudad():
#     input('Ingresa una ciudad: ')
#     return print(f"Hola, te damos la bienvenida a {ciudad}")
# ciudad()

# EJERCICIO DE CIUDAD
# def saludar(ciudad):
#     mensaje = f"Hola, te damos la bienvenida a {ciudad}"
#     print(mensaje)

# saludar("cordoba")

# # Puedes utilizar esta función pasando el nombre de la ciudad como argumento. Por ejemplo, si deseas saludar a alguien en la ciudad de "Madrid", 
